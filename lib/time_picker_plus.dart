...
///
/// In [TimePickerPlusEntryMode.dial] mode, a clock dial is displayed and
/// the user taps or drags the time they wish to select. In
/// TimePickerPlusEntryMode.input] mode, [TextField]s are displayed and the user
/// types in the time they wish to select.
enum TimePickerPlusEntryMode {
...
class _TimePickerDialog extends StatefulWidget {
  ...
  const _TimePickerDialog({
    ...
    required this.helpText,
    this.initialEntryMode = TimePickerPlusEntryMode.dial,
  ...
  final TimePickerPlusEntryMode initialEntryMode;
...
class _TimePickerDialogState extends State<_TimePickerDialog> {
  ...
  bool get _isStaticMode {
    return _entryMode == TimePickerPlusEntryMode.dialOnly ||
        _entryMode == TimePickerPlusEntryMode.inputOnly;
  }
  ...
  late TimePickerPlusEntryMode _entryMode;
  ...
  void _handleEntryModeToggle() {
    setState(() {
      switch (_entryMode) {
        case TimePickerPlusEntryMode.dial:
          _autoValidate = false;
          _entryMode = TimePickerPlusEntryMode.input;
          break;
        case TimePickerPlusEntryMode.input:
          _formKey.currentState!.save();
          _autofocusHour = false;
          _autofocusMinute = false;
          _entryMode = TimePickerPlusEntryMode.dial;
          break;
      }
    });
  }
  ...
  bool get _isInputMode {
    return _entryMode == TimePickerPlusEntryMode.input ||
        _entryMode == TimePickerPlusEntryMode.inputOnly;
  }
  ...
  Size _dialogSize(BuildContext context) {
    ...
    switch (_entryMode) {
      case TimePickerPlusEntryMode.dial:
      case TimePickerPlusEntryMode.dialOnly:
        switch (orientation) {
          case Orientation.portrait:
        ...
        break;
      case TimePickerPlusEntryMode.input:
      case TimePickerPlusEntryMode.inputOnly:
        timePickerWidth = _kTimePickerWidthPortrait;
  ...
  Widget build(BuildContext context) {
      ...
      children: <Widget>[
        ...
        _isStaticMode
            ...
            : IconButton(
                ...
                icon: Icon(_entryMode == TimePickerPlusEntryMode.dial
                    ? Icons.keyboard
                    : Icons.access_time),
                tooltip: _entryMode == TimePickerPlusEntryMode.dial
    ...
    return Dialog(
      ...
      insetPadding: EdgeInsets.symmetric(
        horizontal: 16.0,
        vertical: (_entryMode == TimePickerPlusEntryMode.input ||
                _entryMode == TimePickerPlusEntryMode.inputOnly)
            ? 0.0
            : 24.0,
      ),
...
Future<TimeOfDay?> showTimePickerPlus({
  required BuildContext context,
  required TimeOfDay initialTime,
  TransitionBuilder? builder,
  bool useRootNavigator = true,
  TimePickerPlusEntryMode initialEntryMode = TimePickerPlusEntryMode.dial,
  String? cancelText,
  String? confirmText,
  String? helpText,
